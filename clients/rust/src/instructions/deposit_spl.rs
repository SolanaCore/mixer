...
impl DepositSpl {
  pub fn instruction(&self, args: DepositSplInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: DepositSplInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&DepositSplInstructionData::new()).unwrap();
...
impl Default for DepositSplInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
 pub struct DepositSplInstructionArgs {
                  pub hash: [u8; 32],
                pub amount: u64,
      }


/// Instruction builder for `DepositSpl`.
///
/// ### Accounts:
///
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = DepositSpl {
          ...
          let args = DepositSplInstructionArgs {
  ...
  /// `deposit_spl` CPI accounts.
  pub struct DepositSplCpiAccounts<'a, 'b> {
...
/// `deposit_spl` CPI instruction.
pub struct DepositSplCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: DepositSplInstructionArgs,
  }

impl<'a, 'b> DepositSplCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: DepositSplCpiAccounts<'a, 'b>,
              args: DepositSplInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `DepositSpl` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` signer
...
#[derive(Clone, Debug)]
pub struct DepositSplCpiBuilder<'a, 'b> {
  instruction: Box<DepositSplCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DepositSplCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(DepositSplCpiBuilderInstruction {
      __program: program,
              signer: None,
              commitment: None,
              token_escrow: None,
...
#[derive(Clone, Debug)]
struct DepositSplCpiBuilderInstruction<'a, 'b> {
