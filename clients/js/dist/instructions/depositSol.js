...
function getDepositSolDiscriminatorBytes() {
    return (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8).encode(exports.DEPOSIT_SOL_DISCRIMINATOR);
}
...
function getDepositSolInstructionDataCodec() {
    return (0, kit_1.combineCodec)(getDepositSolInstructionDataEncoder(), getDepositSolInstructionDataDecoder());
}
